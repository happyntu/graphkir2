    ...
    def describe_config(self) -> str:
        ...
        return "\n".join(
            [
                ...
                f"typing_functional_discard_fallback_genes={self.config.typing.functional_discard_fallback_genes or '<none>'}",
                f"typing_functional_discard_fallback_resolution={self.config.typing.functional_discard_fallback_resolution}",
                f"typing_functional_discard_fallback_max_score={self.config.typing.functional_discard_fallback_max_score}",
                f"typing_functional_discard_fallback_min_score_delta={self.config.typing.functional_discard_fallback_min_score_delta}",
                f"typing_functional_discard_fallback_promoted_alleles={self.config.typing.functional_discard_fallback_promoted_alleles or '<none>'}",
                f"typing_functional_discard_fallback_protected_alleles={self.config.typing.functional_discard_fallback_protected_alleles or '<none>'}",
