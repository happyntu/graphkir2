    ...
    def describe(self) -> str:
        ...
        return "\n".join(
            [
                ...
                f"typing_base_top_n={self.typing.base_top_n or '<none>'}",
                f"typing_gene_base_top_ns={self.typing.gene_base_top_ns or '<none>'}",
    ...
    def describe(self) -> str:
        ...
        return "\n".join(
            [
                ...
                f"typing_base_top_n={self.benchmark.typing.base_top_n or '<none>'}",
                f"typing_gene_base_top_ns={self.benchmark.typing.gene_base_top_ns or '<none>'}",
